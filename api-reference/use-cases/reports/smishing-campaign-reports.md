# Pull smishing campaign reports

Retrieve SMS phishing (smishing) campaign data via the API.
...
## Search smishing campaigns

Use the Smishing Campaign search endpoint to list campaigns with filters and pagination. Refer to the OpenAPI spec for the exact path and request body format.
...
| ----------------------- | --------------------------------- | ------ |
| Search smishing campaigns | Smishing Campaign search endpoint | POST   |
| Export                  | Smishing Campaign search/export   | POST   |
