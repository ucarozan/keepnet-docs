# Pull quishing campaign reports

Retrieve QR phishing (quishing) campaign data via the API.
...
## Search quishing campaigns

Use the Quishing Campaign search endpoint to list campaigns with filters and pagination. Refer to the OpenAPI spec for the exact path and request body format.
...
| ----------------------- | --------------------------------- | ------ |
| Search quishing campaigns | Quishing Campaign search endpoint | POST   |
| Export                  | Quishing Campaign search/export   | POST   |
