...
{% openapi src="../../../.gitbook/assets/keepnet-api-spec.json" path="/api/executive-report/search" method="post" expanded="true" %}
[keepnet-api-spec.json](../../../.gitbook/assets/keepnet-api-spec.json)
{% endopenapi %}
...
{% openapi src="../../../.gitbook/assets/keepnet-api-spec.json" path="/api/executive-report/get-widget-datas" method="post" expanded="true" %}
[keepnet-api-spec.json](../../../.gitbook/assets/keepnet-api-spec.json)
{% endopenapi %}
...
**Related:** [Scope API requests to a customer →](scope-api-requests-to-customer.md). [View customer's enrollment list and report →](view-customer-enrollment-list-and-report.md). [View customer's campaign list and report →](view-customer-simulation-campaign-list-and-report.md).
