...
* Added Agentic AI Analysis to Incident Responder > Reported Emails > Email Details > AI Analysis, generating an automated structured assessment (Category, Verdict, Confidence, Risk Level, indicators, evidence flow, and recommended actions) to help SOC teams triage reported emails faster with consistent, explainable results.
