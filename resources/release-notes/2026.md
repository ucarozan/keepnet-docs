...
* Added "Duration" and "Training Level" columns to Awareness Educator > Training Library and Enrollments tables, allowing administrators to scan training duration (e.g. 5 minutes, 15 minutes) and difficulty level (Beginner, Intermediate, Advanced) at a glance and filter the library by either column.
