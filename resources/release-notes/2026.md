...
<summary>17 March</summary>

#### New Features:

* [BETA] Added Agentic AI Settings to Company Settings, introducing Approval-Gated Execution and Autonomous Execution modes, configurable Safeguards, and Behavioral Policies, allowing admins to choose whether AI recommends actions for manual approval or executes them automatically based on defined policies across phishing simulation and training workflows.
...
* Fixed an issue in the platform where navigating to the current page triggered a Vue Router NavigationDuplicated error, ensuring same-route navigation is handled gracefully without errors.
