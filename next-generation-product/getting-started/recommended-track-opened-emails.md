...
{% hint style="info" %}
**Why is this Optional?** Some customers don't measure Opened Email as a metric as it does not indicate secure or risky behaviour. When you complete this step, simulated emails may behave differently to other external emails and attentive employees might notice the difference.
{% endhint %}
