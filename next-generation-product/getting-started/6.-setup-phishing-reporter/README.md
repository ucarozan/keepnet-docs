...
{% content-ref url="../4.-setup-phishing-reporter/integrate-native-microsoft-phishing-report-button-with-keepnet.md" %}
[integrate-native-microsoft-phishing-report-button-with-keepnet.md](../4.-setup-phishing-reporter/integrate-native-microsoft-phishing-report-button-with-keepnet.md)
{% endcontent-ref %}
...
{% content-ref url="../4.-setup-phishing-reporter/deploy-keepnets-customisable-phishing-report-button/" %}
[deploy-keepnets-customisable-phishing-report-button](../4.-setup-phishing-reporter/deploy-keepnets-customisable-phishing-report-button/)
{% endcontent-ref %}
