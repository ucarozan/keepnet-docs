...
<table data-header-hidden><thead><tr><th width="201"></th><th></th><th data-hidden></th></tr></thead><tbody><tr><td>First Name</td><td>User’s first name.</td><td></td></tr><tr><td>Last Name</td><td>User’s surname.</td><td></td></tr><tr><td>Email</td><td>User’s email address.</td><td></td></tr><tr><td>Department</td><td>User’s department.</td><td></td></tr><tr><td>Status</td><td><p>Status of user’s interaction with the training exercise:</p><ul><li><strong>In Queue:</strong> The email is in the queue to be sent to the user. </li><li><strong>Sending Error:</strong> An error occurred while sending the email to the user. </li><li><strong>No Responded:</strong> The user hasn’t responded to the training email.</li><li><strong>Opened Email:</strong> The user only opened the training email. </li><li><strong>In Progress:</strong> The user started but has not completed the training.</li><li><strong>Completed:</strong> The user completed the training. </li><li><strong>Downloaded:</strong> The user downloaded the infographic (or poster).</li><li><strong>Canceled:</strong> The admin canceled the training before the user received the training exercise email.</li></ul></td><td></td></tr><tr><td>Exam Status</td><td><p>Exam status of users:</p><ul><li><strong>Success:</strong> The user has passed the exam.</li><li><strong>Failed:</strong> The user has failed the exam.</li><li><strong>Incomplete:</strong> The user hasn't yet started the exam.</li></ul><p>The <strong>"SHOW BY EXAM STATUS"</strong> button lists the users based on the following orders:</p><ul><li><strong>First Attempt:</strong> List users who passed the exam on the first attempt.</li><li><strong>Passed</strong> <strong>Any</strong> <strong>Attempt:</strong> List users who passed the exam. It doesn't matter if it is first, second, third, or fourth.</li><li><strong>Failed</strong> <strong>Any</strong> <strong>Attempt:</strong> List users who failed the exam. It doesn't matter if it is first, second, third, or fourth.</li></ul></td><td></td></tr><tr><td>Exam Score</td><td>Exam score of users between 0-100.</td><td></td></tr><tr><td>First Completion</td><td>The date the user first completed the training enrollment.</td><td></td></tr><tr><td>Last Interaction</td><td>Last time the user interacted with training.</td><td></td></tr><tr><td>Delivery Type</td><td>The training exercise has been sent via email only or email + SMS together.</td><td></td></tr><tr><td>Actions > Details</td><td>All user interactions with the training exercise, such as interactions, user agents, IPs, and many more info.<br><br>If the Survey enrollment is viewed, the admin can see the <strong>Responses</strong> of employees by clicking the details button.</td><td></td></tr><tr><td>Actions > Resend</td><td>This option allows the admin to resend the same training exercise to a user(s).</td><td></td></tr></tbody></table>

### **Opened Training Email**

This menu provides specific details of the users who opened the training email.

<table data-header-hidden><thead><tr><th width="196"></th><th></th><th data-hidden></th></tr></thead><tbody><tr><td>First Name</td><td>User’s first name</td><td></td></tr><tr><td>Last Name</td><td>User’s surname</td><td></td></tr><tr><td>Email</td><td>User’s email address</td><td></td></tr><tr><td>Department</td><td>User’s department</td><td></td></tr><tr><td>Last Opened</td><td>Date the user last opened the training</td><td></td></tr><tr><td>Times Opened</td><td>Number of times the user opened the training email</td><td></td></tr><tr><td>Actions > Details</td><td>This option provides the date the email was first opened, and the user agent, geolocation, and IP address of the user.</td><td></td></tr><tr><td>Actions > Resend</td><td>This option allows the admin to resend the same training content to a user(s)</td><td></td></tr></tbody></table>

### **Clicked Training Link**

This menu provides details of users who clicked on the training link or downloaded the poster (or infographic) in the email.

<table><thead><tr><th width="224"></th><th></th><th data-hidden></th></tr></thead><tbody><tr><td>First Name</td><td>User’s first name</td><td></td></tr><tr><td>Last Name</td><td>User’s surname</td><td></td></tr><tr><td>Email</td><td>User’s email address</td><td></td></tr><tr><td>Department</td><td>User’s department</td><td></td></tr><tr><td>Last Opened</td><td>Date the user last clicked on the training link</td><td></td></tr><tr><td>Times Opened</td><td>Number of times the user clicked on the training link</td><td></td></tr><tr><td>Actions > Details</td><td>This option provides the date the link was clicked, and the user agent, geolocation, and IP address of the user</td><td></td></tr><tr><td>Actions > Resend</td><td>This option allows the admin to resend the same training content to a user(s)</td><td></td></tr></tbody></table>
