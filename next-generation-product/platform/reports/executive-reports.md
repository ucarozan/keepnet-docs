...
Here is an example Executive Report showing how the metrics look for **Phishing Simulation**, **Security Awareness Training**, **Suspicious Email Reporting** and **Security Culture Score** statistics over time for your organisation.

{% file src="../../../.gitbook/assets/Executive Report Example.pdf" %}
