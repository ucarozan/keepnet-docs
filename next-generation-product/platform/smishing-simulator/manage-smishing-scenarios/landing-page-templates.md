...
The same feature is available in [Phishing Simulator](/next-generation-product/platform/phishing-simulator/manage-phishing-scenarios/landing-pages#how-to-add-a-second-page-using-the-template-picker) and [Quishing Simulator](/next-generation-product/platform/quishing-simulator/manage-quishing-scenarios/quishing-landing-page-templates#how-to-add-a-second-page-using-the-template-picker).
