...
<table><thead><tr><th width="150"></th><th width="580.5714285714286"></th></tr></thead><tbody><tr><td>Notification Templates</td><td><p>There are 3 options:<br></p><ul><li><strong>All Notification Templates =</strong> The company has access to all of the notification templates on the platform including yours that has been shared with the company.</li><li><strong>Only System Notification Templates =</strong> The company only has access to system notification templates.</li><li><strong>Only Reseller's Custom Templates =</strong> The company only has access to the custom notification templates shared by the reseller.</li></ul></td></tr><tr><td>Training Contents</td><td><p>There are 3 options:<br></p><ul><li><strong>All Training Content =</strong> The company has access to all training content shared by the platform or reseller.</li><li><strong>Only System Training Contents =</strong> The company only has access to system training content.</li><li><strong>Only Reseller's Custom Training Content =</strong> The company only has access to the customized reseller training content.</li></ul></td></tr><tr><td>SMTP Configurations</td><td><p>There are 3 options:</p><p></p><ul><li><strong>All SMTP Configurations =</strong> The company has access to all SMTP settings provided by the platform or reseller.</li><li><strong>Only System SMTP Configurations =</strong> The company only has access to SMTP configurations of type SYSTEM which is shared by the platform.</li><li><strong>Only Reseller's Custom SMTP Configurations =</strong> The company only has access to the customized SMTP configurations customized by the Reseller.</li></ul></td></tr></tbody></table>
