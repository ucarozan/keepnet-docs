...
<figure><img src="../../../../.gitbook/assets/image4.png" alt="Ribbon Phishing Reporter button in Outlook."><figcaption><p>Ribbon Phishing Reporter button in Outlook.</p></figcaption></figure>

* When using the new Outlook Ribbon, clicking the Phishing Report button opens a pop-up window instead of a side panel.

<figure><img src="../../../../.gitbook/assets/image10.png" alt="Phishing Report pop-up window on new Outlook Ribbon."><figcaption><p>Phishing Report pop-up window on new Outlook Ribbon.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-05-28 at 11.34.26.png" alt="Permissions requested pop-up — Accept to grant Graph API permissions." width="375"><figcaption><p>Permissions requested pop-up — Accept to grant Graph API permissions.</p></figcaption></figure>

5. Once you accept the permissions, the GRAPH APIs Authorization Successful window will display.

<figure><img src="../../../../.gitbook/assets/Screenshot 2025-10-21 at 10.31.25.png" alt="Graph APIs Authorization Successful window." width="563"><figcaption><p>Graph APIs Authorization Successful window.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/image12.png" alt="Microsoft 365 admin center — entry point for Integrated apps."><figcaption><p>Microsoft 365 admin center — entry point for Integrated apps.</p></figcaption></figure>

8. From the menu on the left side of the page, click **Settings**.
9. From the **Settings** drop-down menu, select **Integrated** **apps**.

<figure><img src="../../../../.gitbook/assets/image6.png" alt="Settings — Integrated apps menu."><figcaption><p>Settings — Integrated apps menu.</p></figcaption></figure>

10. Click Add-ins at the top-right corner of the page. The Add-ins page will open

<figure><img src="../../../../.gitbook/assets/image7.png" alt="Add-ins button on Integrated Apps page."><figcaption><p>Add-ins button on Integrated Apps page.</p></figcaption></figure>

11. On the Add-ins page, click Deploy Add-In. The Deploy a new add-in pop-up window will open.

<figure><img src="../../../../.gitbook/assets/image5.png" alt="Deploy Add-In button."><figcaption><p>Deploy Add-In button.</p></figcaption></figure>

12. In the pop-up window, click Next.

<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-03 at 18.10.27.png" alt="Deploy a new add-in pop-up — Next."><figcaption><p>Deploy a new add-in pop-up — Next.</p></figcaption></figure>

13. Click Upload custom apps.

<figure><img src="../../../../.gitbook/assets/image3.png" alt="Upload custom apps option."><figcaption><p>Upload custom apps option.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/image14.png" alt="Choose File to select PhishingReporterRibbon.xml."><figcaption><p>Choose File to select PhishingReporterRibbon.xml.</p></figcaption></figure>

15. Click **Upload** to install the Phishing Reporter. The **Configure** **add-in** pop-up window will open.

<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-03 at 18.11.21.png" alt="Configure add-in pop-up after upload."><figcaption><p>Configure add-in pop-up after upload.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-03 at 18.10.59 (1).png" alt="Deploy Phishing Reporter — select users and deployment method."><figcaption><p>Deploy Phishing Reporter — select users and deployment method.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-03 at 18.11.29.png" alt="Add-in successfully installed message."><figcaption><p>Add-in successfully installed message.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-03 at 18.15.27.png" alt="Announce add-in pop-up — Microsoft recommendation message."><figcaption><p>Announce add-in pop-up — Microsoft recommendation message.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-03-31 171409.png" alt="Troubleshooting — We were unable to process this item or related Ribbon error."><figcaption><p>Troubleshooting — "We were unable to process this item" or related Ribbon error.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Screenshot 2025-10-21 at 16.05.58.png" alt="Screenshot reference of the error:" width="375"><figcaption><p>Error or issue reference when using Phishing Reporter (e.g. Conditional Access).</p></figcaption></figure>
...
<div align="center" data-full-width="false"><figure><img src="../../../../.gitbook/assets/image.webp" alt="New Outlook — Phishing Reporter button in toolbar when viewing an email." width="563"><figcaption><p>New Outlook — Phishing Reporter button in toolbar when viewing an email.</p></figcaption></figure></div>
...
<figure><img src="../../../../.gitbook/assets/image (1).webp" alt="Classic Outlook — Phishing Reporter button on ribbon toolbar." width="563"><figcaption><p>Classic Outlook — Phishing Reporter button on ribbon toolbar.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/image (2).webp" alt="Outlook Web App (OWA) — Phishing Reporter in action toolbar." width="563"><figcaption><p>Outlook Web App (OWA) — Phishing Reporter in action toolbar.</p></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/image (3).webp" alt="Outlook for Mac — Report dropdown and Phishing Reporter option." width="563"><figcaption><p>Outlook for Mac — Report dropdown and Phishing Reporter option.</p></figcaption></figure>
...
<div data-full-width="true"><figure><img src="../../../../.gitbook/assets/image (4).webp" alt="Outlook Mobile — Suspicious Email Reporter in three-dot menu." width="188"><figcaption><p>Outlook Mobile — Suspicious Email Reporter in three-dot menu.</p></figcaption></figure></div>
