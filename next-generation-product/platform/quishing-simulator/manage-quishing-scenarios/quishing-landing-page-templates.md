...
The same feature is available in [Phishing Simulator](../../../phishing-simulator/manage-phishing-scenarios/landing-pages#how-to-add-a-second-page-using-the-template-picker) and [Smishing Simulator](../../../smishing-simulator/manage-smishing-scenarios/landing-page-templates#how-to-add-a-second-page-using-the-template-picker).
