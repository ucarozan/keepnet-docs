...
2.3 Availability and Uptime. For details of ’s Service Uptime Commitment, please see the [Product Specific Terms](product-specific-terms.md).
...
You will notify us promptly of any unauthorized use of your Users' identifications and passwords or your account through our [Customer Help Desk](../../resources/keepnet-support-help-desk.md).
...
Changes may be made on your Billing Page within your account. You authorize to continue to charge your Authorized Payment Method for applicable fees during your Subscription Term and until any and all outstanding Fees have been paid in full. All payment obligations are non-cancelable and all amounts paid are non-refundable, except as specifically provided for in this Agreement. All fees are due and payable in advance throughout the Subscription Term. If you are a Channel Partner that purchases on behalf of a client, you agree to be responsible for the Order Form and to guarantee payment of all fees.
...
If you decide not to renew, you can send us this non-renewal notice by indicating your decision in one of two ways: by asking to turn off auto-renewal in the billing details or by contacting us through our [Customer Help Desk Portal](https://support.keepnetlabs.com/).
...
5.5 Regional Data Hosting. We will store your Customer Data in a specific location or geographical region (e.g. US, UK or EU) as part of your subscription subject to the terms of this Agreement and our [Regional Data Hosting Policy](regional-data-hosting-policy.md).

5.6 Customer Data Transfers. We and our Affiliates may transfer Customer Data (including Personal Data) outside your Location in connection with the Subscription Service, as described in our Regional Data Hosting Policy. Where we transfer Personal Data that is subject to European Data Protection Laws (as defined in the DPA) to a country that does not provide an adequate level of protection, we rely on the Standard Contractual Clauses and, for transfers from the UK, the UK Addendum, as set out in our DPA.
